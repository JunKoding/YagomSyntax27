...
// 오류 발생의 여지가 있는 메소드는 throws를 사용하여
// 오류를 내포하는 함수임을 표시한다.
...
// 오류가 발생했으면 결과값을 nil로 돌려 받을 수 있다.
// 정상 작동 후에는 옵셔널 타입으로 정상 반환값을 돌려 받는다.
...
// try!를 사용하면 정상 동작 후에 바로 결과값을 돌려받는다.
